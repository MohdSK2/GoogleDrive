  ...
  function Body() {
    ...
    this._initBody = function (body, options) {
      ...
      if (typeof body === "string") {
        ...
        //TODO Had to do this because we were getting an error for a 'file' input
    ...
    return new Promise(function (resolve, reject) {
      ...
      function onload() {
        ...
        if (status < 100 || status > 599) {
          ...
          reject(
            new TypeError(
              `Network request failed. Status Code: ${xhr.status}; StatusText: ${xhr.statusText}; ResponseText: ${xhr.responseText}`
            )
          );
          return;
        }
      ...
      xhr.onerror = function () {
        ...
        reject(
          new TypeError(
            `Network request failed. Status Code: ${xhr.status}; StatusText: ${xhr.statusText}; Body: ${xhr.body}`
          )
        );
      };
      ...
      if (
        ("responseType" in xhr && support.blob) ||
